...
const Err = () => {
  ...
  return (
    ...
    <svg className="emoji-404" xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 226 249.135" viewBox="0 0 226 249.135" width="226" height="249.135" xmlSpace="preserve">
          <circle cx="113" cy="113" fill="#FFE585" r="109"/>
          <line fill="none" opacity="0.29" stroke="#6E6E96" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="88.866" y1="245.135" x2="136.866" y2="245.135"/>
          <line fill="none" opacity="0.17" stroke="#6E6E96" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="154.732" y1="245.135" x2="168.732" y2="245.135"/>
          <line fill="none" opacity="0.17" stroke="#6E6E96" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8" x1="69.732" y1="245.135" x2="58.732" y2="245.135"/>
          ...
          <ellipse cx="67.732" cy="140.894" fill="#FF0000" opacity="0.18" rx="17.372" ry="8.106"/>
          <ellipse cx="154.88" cy="140.894" fill="#FF0000" opacity="0.18" rx="17.371" ry="8.106"/>
    ...
    <a href="#" className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Go back </a>
    </center>
    </div>
  )
}
